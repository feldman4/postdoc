...
INPUT=/net/expdata/mass-spec/Xinting/barcode_mix_dilutelongc18.mzdata.xml
SAMPLE_NAME=barcode_mix_dilutelongc18
...
MZML_FILTERS="-rt 240:600 -mz 580:820 -int 100:"

DINO_THREADS=2
DINO_OPTIONS="--verbose --profiling --concurrency=$DINO_THREADS --nReport=1000 --reportSeed=1"
...
DINO_TARGETS="--targets=/home/dfeldman/flycodes/ms/20210211_standards/targets.tsv --targetPreference=intensity --reportTargets"
...
echo "hillPPM=4" >> advParams.txt
echo "hillMinLength=10" >> advParams.txt
